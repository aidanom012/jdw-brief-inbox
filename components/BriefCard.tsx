...
export function BriefCard({ brief }: BriefCardProps) {
  ...
  return (
    <article className="animate-rise pixel-window p-5 transition duration-150 hover:-translate-y-1">
      ...
      <div className="mt-5">
        <h2 className="text-2xl font-black tracking-tight">{display(brief.artist)}</h2>
        <p className="mt-1 font-semibold pixel-muted">{display(brief.release_title)}</p>
      </div>
      ...
      <div className="mt-5 flex flex-wrap items-center justify-between gap-3">
        <span className="pixel-missing px-3 py-2 font-mono text-xs font-black uppercase tracking-[0.12em]">
